...
def merge_data_for_year(year):
    ...
    # Load data files
    old_df = pd.read_csv(f"/Users/sanjiv/jeevs-cbb/backend/data/{year}-players.csv")
    new_df = pd.read_csv(f"/Users/sanjiv/jeevs-cbb/backend/data/{year}-PlayerData.csv")
...
# -------------------------
    ...
    # Save
    # -------------------------
    output_file = f"/Users/sanjiv/jeevs-cbb/backend/data/{year}-players_enriched.csv"
