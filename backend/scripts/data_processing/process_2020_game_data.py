...
def link_player_ids(game_data_file, roster_file, player_data_file, output_file):
    ...
    unmatched_file = os.path.join(os.path.dirname(output_file), "unmatched_players_2020.csv")
    if unmatched:
...
if __name__ == "__main__":
    game_data_file = os.path.join(BASE_DIR, "data", "games", "2020_player_game_data.json")
    ...
    if isinstance(data[0], dict):
        ...
        print(f'Loaded {len(data)} games from 2020')
        ...
        print('Saved converted data to 2020_player_game_data.json')

    # Step 2: Link player IDs
    roster_file = os.path.join(BASE_DIR, "data", "players", "2020-roster-info.csv")
    player_data_file = os.path.join(BASE_DIR, "data", "players", "2020-PlayerData.csv")
