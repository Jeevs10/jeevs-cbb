import { getPlayerMoves } from "@/lib/moves";
...
export default function PlayerMovesPanel({ player }) {
  const moves = getPlayerMoves(player);
      ...
      {moves.map((m, i) => (
        ...
        >
          ...
          <div className="text-right">
            ...
            <div className="text-[10px]">Grade: {getGrade(m.efficiency)}</div>
          </div>
        </div>
      ))}
    </div>
